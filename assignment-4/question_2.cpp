...
/*Write a program to design Classes for Student, Clerk, Professor. Each of these
...
{
    cout << endl;
    cout << " entering student details --> " << endl;
    cout << endl;
    ...
    cout << " entering clerk details --> " << endl;
    cout << endl;
    ...
    cout << " entering professor details --> " << endl;
    cout << endl;
